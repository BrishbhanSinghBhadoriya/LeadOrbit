...
import {
  ...
  FileText, ClipboardList, Bell, UserCog, Settings,
  Kanban, GraduationCap, BookOpen, ChevronRight, X, Menu,
} from "lucide-react";

// WhatsApp SVG icon component for sidebar
function WhatsAppSidebarIcon({ className }: { className?: string }) {
  return (
...
const NAV: NavItem[] = [
  ...
  { href: "/whatsapp",      label: "WhatsApp",        icon: WhatsAppSidebarIcon, roles: ["super_admin","admin","general_manager","manager","team_leader","counselor"] },
