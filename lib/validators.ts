...
export const leadSchema = z.object({
  ...
  paymentStatus: z.enum(["paid", "partial_paid", "pending"]).default("pending"),
  callStatus: z.enum(["connected", "not_connected", "switched_off", "busy", "wrong_number"]).optional(),
  whatsappStatus: z.enum(["replied", "not_replied", "sent"]).optional(),
  emailStatus: z.enum(["opened", "not_opened", "clicked"]).optional(),
  admissionStage: z.enum(["documents_pending", "verification", "payment_pending", "admission_complete"]).optional(),
